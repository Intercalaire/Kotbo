  ...
  {#snippet actions()}
    {#if showEditor}
      <button
        ...
        class="px-5 py-2.5 bg-surface-container-high text-on-surface font-medium text-body-sm rounded-lg shadow hover:bg-surface-container-highest transition-all"
      >
        {m.news_back_to_list()}
      </button>
    {:else if canEdit}
      <button
        onclick={openCreate}
        class="px-6 py-2.5 bg-primary text-on-primary font-medium text-body-sm rounded-lg transition-all"
      >
        {m.news_create_btn()}
      </button>
    {/if}
      ...
      <section class="bg-surface-container-low/30 border border-outline-variant/10 p-8 rounded-xl space-y-6">
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="flex items-center justify-between p-4 rounded-lg bg-surface-container-high/20 border border-outline-variant/5">
              <div>
                ...
                <p class="text-2xs text-on-surface-variant/50">{m.news_publish_now_sub()}</p>
              </div>
              <input 
                type="checkbox" 
          ...
          <div class="pt-4 flex justify-end gap-4">
            ...
            <button 
              onclick={handleSave}
              class="px-8 py-3 bg-primary text-on-primary font-medium text-body-sm rounded-lg transition-all"
            >
                              ...
                              {#each subcategorySection.articles as art}
                                <article class="group rounded-[1.6rem] border border-outline-variant/10 bg-surface-container-high/25 p-4 transition-all hover:-translate-y-0.5 hover:border-primary/25 hover:bg-surface-container-high/40">
                                  <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                    ...
                                    <div class="flex shrink-0 flex-wrap items-center gap-3 text-2xs text-on-surface-variant/70">
              ...
              <div class="space-y-6">
                ...
                <div class="space-y-4">
                  ...
                  <button
                    ...
                    class="w-full mt-2 py-3 bg-on-surface text-surface font-medium text-body-sm rounded-lg hover:opacity-90 transition-all"
                  >
                    ...
                    <article class="rounded-xl border border-outline-variant/10 bg-surface-container-high/25 p-5 md:p-6 transition-all hover:-translate-y-0.5 hover:bg-surface-container-high/35">
                      ...
                      <div class="mt-5 rounded-lg border border-outline-variant/10 bg-surface-container-low/40 px-4 py-3">
                        ...
                        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                          ...
                          <span class="text-2xs font-medium text-on-surface-variant/60">
