 ...
 *
 * Le catalogue vit ici plutôt que côté bot parce que le dashboard doit le lire
 * pour proposer un enchantement à la création d'un parchemin. Il ne dépend de
 * rien d'autre que de la rareté, déclarée juste à côté.
 */

import type { RpgItemRarity as Rarity } from './economy.js';
